...
states_of_america.append("Doveland")  # Adds and item to the end of the list
# Adds a list to the end of a previous list
states_of_america.extend(['Donnaland', 'Maxester', 'Rosecastle'])
